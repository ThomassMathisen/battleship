...
describe('Gameboard', () => {
  ...
  test('prevents placement outside the board', () => {
    gameboard.placeShip(ship, 1, 1, true)
  ...
  test('prevents placement on taken fields', () => {
    gameboard.placeShip(ship, 1, 1, true)
  ...
  test('prevents placement in direct neighborhood of taken fields', () => {
    gameboard.placeShip(ship, 1, 1, true)
